...
<head>
  ...
  <!-- <script type="text/javascript">
      function addToCart(){
        $.ajax({url:"add_to_cart.php", success:function(){
          location:reload();
        }
        })
      }
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="produkty_cyfrowe.php" class="list-group-item active">Cyfrowe</a>
      ...
      <div class="col-lg-9">
        ...
        try {
          ...
          if($connect->connect_errno!=0){
            ...
            $sql = "SELECT * FROM produkty WHERE id_kategoria=1 ORDER BY id_produkt ASC";
