                    ...
                    $id_zamowienia = $row_produkt_exist['id_zamowienia'];
                      if(!$result_update = $connect -> query(
                          ...
                          WHERE id_zamowienia='$id_zamowienia'")){
                              ...
                              header('Location: produkty_klawiszowe.php');
                          }  
                  } else {
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="produkty_klawiszowe.php" class="list-group-item active">Klawiszowe</a>
          <a href="produkty_guzikowe.php" class="list-group-item text-dark">Guzikowe</a>
        </div>
      </div>
      ...
      <div class="col-lg-9">
        ...
        try {
          ...
          if($connect->connect_errno!=0){
            ...
            $sql = "SELECT * FROM produkty WHERE id_kategoria=2 ORDER BY id_produkt ASC";
